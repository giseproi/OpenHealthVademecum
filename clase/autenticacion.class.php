...
class autenticacion
{
	...
	function mensaje_error($configuracion)
		{?>
	<link rel='stylesheet' type='text/css' href='<?php echo $configuracion["host"].$configuracion["site"].$configuracion["estilo"]."/basico/estilo.php" ?>' />
		...
		<tr>
			<td colspan="2"> 
				...
				<tbody>
					...
					Si el problema persiste por favor contacte al administrador del sistema en:<br><a href="mailto:<?php echo $configuracion["correo"]?>"><?php echo $configuracion["correo"]?></a><br>
					</td>
					</tr>		      	
				</tbody>
				</table>
