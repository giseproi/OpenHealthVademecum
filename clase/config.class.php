...
*                                                                          *
*                                                                          *
* OpenHealthVademecum es software libre. Puede redistribuirlo y/o modificarlo bajo los    *
...
*                                                                          *
* OpenHealthVademecum se distribuye con la esperanza de que sea util, pero SIN NINGUNA    *
...
* con OpenHealthVademecum; si esto no ocurrio, escriba a la Free Software Foundation, Inc,*
...
* @revision      ultima revision 6 de septiembre de 2016
****************************************************************************
* @subpackage   
...
class config
{
	...
	function variable($ruta="")
	{
		...
		if (is_resource($this->base->enlace))
		{		
			$cadena_sql="SELECT ";
