								...
								<table align="center" cellpadding="10" cellspacing="0" >
									<tr class="bloquecentralcuerpo">
										<td valign="middle" align="right" >
											<a href="<?php echo $_REQUEST["host"].$_REQUEST["site"]?>/index.php">Terminar</a>
										</td>
									</tr>
								</table> 
							</td>
			...
			<table cellpadding="10" cellspacing="0" >
				<tr class="bloquecentralcuerpo">
					<td valign="middle">
						...
						{
							case 0:	?>
						<img src="boton_rojo.png" border="0" /><?php
							break;
							
						   	case 1:
						?>	
						<img src="boton_verde.png" border="0" /><?php
							break;
							
						   	case 2:
						?>	
						<img src="boton_gris.png" border="0" /><?php
							break;
						  }
						?>	
					</td>
