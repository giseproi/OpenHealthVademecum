...
* @link		N/D
* @description  Formulario de registro de procedimientoes
...
$formulario="registro_procedimiento";
...
if(isset($_REQUEST['opcion']))
{
	...
	if($accion=="mostrar")
	{
		...
		{
			mostrar_registro_procedimiento($configuracion,$tema,$_REQUEST['id_procedimiento']);
		}
	}
	else
	{
		...
		if($accion=="nuevo")
		{
			nuevo_registro_procedimiento($configuracion,$tema,$accion,$formulario,$verificar,$fila,$tab,$el_estilo);
		...
		else
		{
			if($accion=="editar")
			{
				editar_registro_procedimiento($configuracion,$tema,$accion,$formulario,$verificar,$fila,$tab,$el_estilo);
			...
			else
			{
				if($accion=="corregir")
				{
					corregir_registro_procedimiento($configuracion,$tema,$accion,$formulario,$verificar,$fila,$tab);
...
{
	$accion="nuevo";
	nuevo_registro_procedimiento($configuracion,$tema,$accion,$formulario,$verificar,$fila,$tab);
}
...
function nuevo_registro_procedimiento($configuracion,$tema,$accion,$formulario,$verificar,$fila,$tab,$estilo)
{
				...
				<table class='bloquelateral' align='center' width='100%' cellpadding='0' cellspacing='0'>
					...
					<table align='center' width='100%' cellpadding='7' cellspacing='1'>
						<tr class="bloquecentralencabezado">
							<td colspan="2" rowspan="1">::.. Registro para Nuevo Procedimiento</td>
						</tr>
						<tr class='bloquecentralcuerpo' <?php echo efecto_fila($contador++,$tema); ?>>
							<td bgcolor='<?php echo $tema->celda ?>'>
								<span onmouseover="<?php 
								$texto_ayuda="<b>C&oacute;digo Unico de Procedimientos en Salud</b><br>";
								$texto_ayuda.="Seg&uacute;n adaptaci&oacute;n para Colombia de la ICD-9-PCS.";											
								echo "this.T_WIDTH=200;return escape('".$texto_ayuda."')" ?>">
								C&oacute;digo CUPS:</span>
							</td>
							<td bgcolor='<?php echo $tema->celda ?>'>
								<input type='text' name='cups' size='30' maxlength='255' tabindex='<?php echo $tab++ ?>' >
							</td>
						</tr>
						<tr class='bloquecentralcuerpo' <?php echo efecto_fila($contador++,$tema); ?>>
							<td bgcolor='<?php echo $tema->celda ?>'>
						...
						<tr class='bloquecentralcuerpo' <?php echo efecto_fila($contador++,$tema); ?>>
							<td colspan="2" bgcolor='<?php echo $tema->celda ?>'>
								<span class="texto_negrita">Indicaci&oacute;n:</span>
							</td>
						</tr>	
						<tr class='bloquecentralcuerpo'>
							<td colspan="2" align="center">
						...
						<tr class='bloquecentralcuerpo' <?php echo efecto_fila($contador++,$tema); ?>>
							<td colspan="2" bgcolor='<?php echo $tema->celda ?>'>
								<span class="texto_negrita">T&eacute;cnica:</span>
							</td>
						</tr>	
						<tr class='bloquecentralcuerpo'>
							<td colspan="2" align="center">
								<textarea id='tecnica' name='tecnica' cols='50' rows='2' tabindex='<?php echo $tab++ ?>' ></textarea>
								<script type="text/javascript">
									mis_botones='<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/';
									archivo_css='<?php echo $configuracion["host"].$configuracion["site"].$configuracion["estilo"]."/".$estilo."/estilo.php" ?>';
									editor_html('tecnica', 'bold italic underline | left center right | number bullet | wikilink');
								</script>
							</td>
						</tr>
						<tr class='bloquecentralcuerpo' <?php echo efecto_fila($contador++,$tema); ?>>
							<td colspan="2" bgcolor='<?php echo $tema->celda ?>'>
								<span class="texto_negrita">Expectativa:</span>
							</td>
						</tr>	
						<tr class='bloquecentralcuerpo'>
							<td colspan="2" align="center">
								<textarea id='expectativa' name='expectativa' cols='50' rows='2' tabindex='<?php echo $tab++ ?>' ></textarea>
								<script type="text/javascript">
									mis_botones='<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/';
									archivo_css='<?php echo $configuracion["host"].$configuracion["site"].$configuracion["estilo"]."/".$estilo."/estilo.php" ?>';
									editor_html('expectativa', 'bold italic underline | left center right | number bullet | wikilink');
								</script>
							</td>
						</tr>
						<tr class='bloquecentralcuerpo' <?php echo efecto_fila($contador++,$tema); ?>>
						...
						<tr align="center" class="bloquecentralcuerpo">
							<td align="center"><?php
							$datos.="&action=registro_procedimiento";						
...
function editar_registro_procedimiento($configuracion,$tema,$accion,$formulario,$verificar,$fila,$tab,$estilo)
{
		...
		<tr>
			<td align="center" valign="middle">
				<table class='bloquelateral' align='center' width='100%' cellpadding='0' cellspacing='0'>
					...
					<table align='center' width='100%' cellpadding='7' cellspacing='1'>
						<tr class="bloquecentralencabezado">
							<td colspan="2" rowspan="1">::.. Editar Procedimiento</td>
						</tr>
						<tr class='bloquecentralcuerpo' <?php echo efecto_fila($contador++,$tema); ?>>
							<td bgcolor='<?php echo $tema->celda ?>'>
								<span onmouseover="<?php 
							...
							<td bgcolor='<?php echo $tema->celda ?>'>
								<input type='text' name='cups' size='30' maxlength='255' tabindex='<?php echo $tab++ ?>' value="<?php echo $registro[0][4]?>">
							</td>
						</tr>
						<tr class='bloquecentralcuerpo' <?php echo efecto_fila($contador++,$tema); ?>>
							<td bgcolor='<?php echo $tema->celda ?>'>
						...
						<tr class='bloquecentralcuerpo'>
							<td colspan="2" align="center">
								<textarea id='definicion' name='definicion' cols='50' rows='2' tabindex='<?php echo $tab++ ?>' ><?php echo $registro[0][2]?></textarea>
								<script type="text/javascript">
									mis_botones='<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/';
									archivo_css='<?php echo $configuracion["host"].$configuracion["site"].$configuracion["estilo"]."/".$estilo."/estilo.php" ?>';
									editor_html('definicion', 'bold italic underline | left center right | number bullet |');
						...
						<tr class='bloquecentralcuerpo'>
							<td colspan="2" align="center">
								<textarea id='descripcion' name='descripcion' cols='50' rows='2' tabindex='<?php echo $tab++ ?>' ><?php echo $registro[0][3]?></textarea>
								<script type="text/javascript">
									mis_botones='<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/';
									archivo_css='<?php echo $configuracion["host"].$configuracion["site"].$configuracion["estilo"]."/".$estilo."/estilo.php" ?>';
									editor_html('descripcion', 'bold italic underline | left center right | number bullet | wikilink');
						...
						<tr class='bloquecentralcuerpo'>
							<td colspan="2" align="center">
								<textarea id='tecnica' name='tecnica' cols='50' rows='2' tabindex='<?php echo $tab++ ?>' ><?php echo $registro[0][6]?></textarea>
								<script type="text/javascript">
									mis_botones='<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/';
									archivo_css='<?php echo $configuracion["host"].$configuracion["site"].$configuracion["estilo"]."/".$estilo."/estilo.php" ?>';
									editor_html('tecnica', 'bold italic underline | left center right | number bullet | wikilink');
						...
						<tr class='bloquecentralcuerpo'>
							<td colspan="2" align="center">
								<textarea id='expectativa' name='expectativa' cols='50' rows='2' tabindex='<?php echo $tab++ ?>' ><?php echo $registro[0][7]?></textarea>
								<script type="text/javascript">
									mis_botones='<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/';
									archivo_css='<?php echo $configuracion["host"].$configuracion["site"].$configuracion["estilo"]."/".$estilo."/estilo.php" ?>';
									editor_html('expectativa', 'bold italic underline | left center right | number bullet | wikilink');
						...
						<tr class='bloquecentralcuerpo' <?php echo efecto_fila($contador++,$tema); ?>>
							<td bgcolor='<?php echo $tema->celda ?>'><?php
								if($registro[0][8]!="N/D")
								{
							?>	<img width="100" height="120" src="<?php echo $configuracion["host"].$configuracion["site"].$configuracion["fotografia"]."/".$registro[0][8] ?>" alt="Procedimiento" title="Procedimiento" border="0" />
							<?php      }
								else
								{
							?>	<img width="100" height="120" src="<?php echo $configuracion["host"].$configuracion["site"].$configuracion["fotografia"]."/sin_imagen.jpg" ?>" alt="Procedimiento" title="Procedimiento" border="0" />
							<?php	}
						?>	</td>
							<td bgcolor='<?php echo $tema->celda ?>'>
						...
						<tr align="center" class="bloquecentralcuerpo">
							...
							$datos=$cripto->codificar($datos,$configuracion);	
							?>	<input type='hidden' name='formulario' value="<?php echo $datos ?>">
								<input type='hidden' name='id_procedimiento' value="<?php echo $registro[0][0] ?>">
								<input value="Enviar" name="aceptar" tabindex='<?php echo $tab++ ?>' type="submit"><br>								
							</td>
							<td align="center">
								<input name='cancelar' value='Cancelar' type='submit'><br>
...
function mostrar_registro_procedimiento($configuracion,$tema,$id_procedimiento)
{
	$acceso_db=new dbms($configuracion);
	$enlace=$acceso_db->conectar_db();
	if (is_resource($enlace))
	{
		...
		$cadena_sql.=$configuracion["prefijo"]."procedimiento "; 
		$cadena_sql.="WHERE ";
		$cadena_sql.="`id_procedimiento`=".$id_procedimiento." ";
		$cadena_sql.="LIMIT 1 ";
	...
	<tr>
		<td>
			<table class='bloquecentralcuerpo' align='center' width='100%' cellpadding='7' cellspacing='1'>
				...
				<tr class='bloquecentralcuerpo'>
					<td>
						...
						$texto_ayuda.="Seg&uacute;n adaptaci&oacute;n para Colombia de la ICD-9-PCS.";											
						echo "this.T_WIDTH=200;return escape('".$texto_ayuda."')" ?>">
						CUPS: <?php echo $registro[0][4] ?></span><br>
						<span class="encabezado_registro"><?php echo strtoupper($registro[0][1]) ?></span>
					</td>
					<td><?php
						if($registro[0][8]!="N/D")
						{
					?>	<img width="100" height="100" src="<?php echo $configuracion["host"].$configuracion["site"].$configuracion["fotografia"]."/".$registro[0][8] ?>" alt="Procedimiento" title="Procedimiento" border="0" />
					<?php      }
						else
						{
			...
			?>
				<tr class='texto_subtitulo'>
					<td colspan="2">
						Indicaci&oacute;n<hr class="hr_subtitulo" />
					</td>
				</tr>
				<tr class='bloquecentralcuerpo'>
					<td colspan="2">
			...
			?>
				<tr class='texto_subtitulo'>
					<td colspan="2">
						Expectativa<hr class="hr_subtitulo" />
					</td>
				</tr>
				<tr class='bloquecentralcuerpo'>
					<td colspan="2">
			...
			<tr class='texto_subtitulo'>
					<td colspan="2">
						T&eacute;cnica<hr class="hr_subtitulo" />
					</td>
				</tr>				
				<tr class='bloquecentralcuerpo'>
					<td colspan="2">
