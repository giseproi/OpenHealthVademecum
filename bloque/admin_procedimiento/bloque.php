...
*****************************************************************************
* @subpackage   admin_procedimiento
* @package	bloques
* @copyright    
* @version      0.3
* @author      	Paulo Cesar Coronado
* @link		N/D
* @description  Bloque principal para la administración de procedimientoes
*
******************************************************************************/
...
if (is_resource($enlace))
{
	...
	if($campos==0)
	{
		sin_registro_procedimiento($configuracion);	
	}
	else
	{
		if(isset($_REQUEST["mostrar"]))
		{
			if($_REQUEST["mostrar"]=="lista")
			{
				...
				con_registro_procedimiento($configuracion,$registro,$campos,$tema);
				navegacion($configuracion,$hoja);
			}
			else
			{
...
function sin_registro_procedimiento($configuracion)
{
						...
						<table cellpadding="10" cellspacing="0" align="center">
							<tr class="bloquecentralcuerpo">
								...
								switch ($_REQUEST["accion"])
								{
									case 1:
								?>
									<b>Hasta el momento usted no ha ingresado procedimientos m&eacute;dicos.</b><hr class="hr_division">
									<br>Realice una b&uacute;squeda con alg&uacute;n criterio para explorar los registros ingresados por otros usuarios.
								<?php
									break; 
									
									default:
								?>
									<b>No existen procedimientos m&eacute;dicos registrados que cumplan con los criterios de b&uacute;squeda.</b>
								<?php
									break;
								}
								?></td>
...
function con_registro_procedimiento($configuracion,$registro,$campos,$tema)
{
						...
						<td>
							<table width="100%" class="bloquecentralcuerpo" cellpadding="0" cellspacing="0">
								<tr>
									...
									$variable.="&id_procedimiento=".$registro[$contador][0];
									...
									$variable=$cripto->codificar_url($variable,$configuracion);
									echo $indice.$variable;	
									?>"><img width="24" heigth="24" src="<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]."/editar.png"?>" alt="Editar esta procedimiento" title="Editar esta procedimiento" border="0" />	
									<?php
									}
									?></td>
								</tr>
								<tr>
									<td>
									<span class="texto_negrita">C&oacute;digo: </span><?php echo $registro[$contador][4] ?>
									</td>
									<td align="center" width="5%" ><?php
									if($_REQUEST["accion"]==1)
									{
									...
									echo $indice.$variable;	
									?>"><img width="24" heigth="24" src="<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]."/boton_borrar.png"?>" alt="Borrar esta procedimiento" title="Borrar esta procedimiento" border="0" /></a>	
									<?php
									}									
									?></td>
								</tr>
		...
		<tr>
			<td >
				...
				<tr class="bloquecentralcuerpo">
					...
					$variable="pagina=admin_procedimiento";	
...
function cadena_busqueda($configuracion,$usuario)
{
	...
	if(isset($_REQUEST["accion"]))
	{
		...
		switch($_REQUEST["accion"])
		{	
			//Todas las procedimientos que el usuario haya creado
			case '1':				
				$cadena_sql.="WHERE ";
			...
			case '2':
				...
				if(isset($_REQUEST["opcion"]))
				{
					...
					{
						//Por denominacion, descripcion o definicion
						case 0:
						...
						case 2:
							...
							$cadena_sql.="descripcion like '%".$_REQUEST["busqueda"]."%' ";						
							$cadena_sql.="OR ";
							$cadena_sql.="cups like '%".$_REQUEST["busqueda"]."%' ";
							$cadena_sql.="OR ";
							$cadena_sql.="indicacion like '%".$_REQUEST["busqueda"]."%' ";
							$cadena_sql.="OR ";
							$cadena_sql.="tecnica like '%".$_REQUEST["busqueda"]."%' ";
							$cadena_sql.="OR ";
							$cadena_sql.="expectativa like '%".$_REQUEST["busqueda"]."%' ";
