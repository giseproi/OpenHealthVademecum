				...
				<table width="100%" border="0" cellpadding="5" cellspacing="0" class="bloquelateral">
					...
					<tr class="bloquelateralcuerpo">
						<td width="100%">
							...
							?>">Todos los usuarios <b>(<?phpecho $todo ?>)</b></A>
						</td>
					</tr>
					<tr class="bloquelateralcuerpo">
						<td width="100%">
							...
							$variable=$cripto->codificar_url($variable,$configuracion);
							echo $indice.$variable;	
							?>">Usuarios activos <b>(<?phpecho $activo ?>)</b></A>
						</td>
					</tr>
					<tr class="bloquelateralcuerpo">
						<td width="100%">
							...
							$variable=$cripto->codificar_url($variable,$configuracion);
							echo $indice.$variable;
							?>">Usuarios inactivos <b>(<?phpecho $inactivo ?>)</b></A>
						</td>
					</tr>
					<tr class="bloquelateralcuerpo">
						<td width="100%">
					...
					<tr class="centralcuerpo">
						<td width="100%" >
							<img src="<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/buscar.png"  border="0" /> Buscar Usuario
						</td>
					</tr>
					<tr class="centralcuerpo">
