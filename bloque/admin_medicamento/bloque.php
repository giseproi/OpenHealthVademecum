...
if (is_resource($enlace))
{
	...
	if($campos==0)
	{
		sin_registro_medicamento($configuracion);	
	}
	else
	{
		if(isset($_REQUEST["mostrar"]))
		{
			if($_REQUEST["mostrar"]=="lista")
			{
				...
				con_registro_medicamento($configuracion,$registro,$campos,$tema);
				navegacion($configuracion,$hoja);
			}
			else
			{
...
function sin_registro_medicamento($configuracion)
{
						...
						<table cellpadding="10" cellspacing="0" align="center">
							<tr class="bloquecentralcuerpo">
								...
								switch ($_REQUEST["accion"])
								{
									case 1:
								?>
									<b>Hasta el momento usted no ha ingresado Medicamentos.</b><hr class="hr_division">
								...
								<?php
									...
									default:
								?>
									<b>No existen M&eacute;dicamentos registrados que cumplan con los criterios de b&uacute;squeda.</b>
								<?php
									break;
								}
								?></td>
...
function con_registro_medicamento($configuracion,$registro,$campos,$tema)
{
...
?><table width="100%" align="center" border="0" cellpadding="10" cellspacing="0" >
	...
	{			?>	<tr class="bloquecentralcuerpo" >
						<td align="center" ><?php
		if(($registro[$contador][10]!="") && ($registro[$contador][10]!="N/D"))
		{
					?>	
						
						<img width="60" height="60" src="<?php echo $configuracion["host"].$configuracion["site"]."/fotografia/".$registro[$contador][10] ?>" alt="Imagen Caracter&iacute;stica" title="Imagen Caracter&iacute;stica" border="0" />
					<?php
		}	
					?>	</td>
						<td>
							<table width="100%" class="bloquecentralcuerpo" cellpadding="0" cellspacing="0">
								<tr>
									...
									$variable.="&id_medicamento=".$registro[$contador][0];
								...
								<tr>
									<td>
									<span class="texto_negrita">C&oacute;digo ATC: </span><?php echo $registro[$contador][2] ?>
									</td>
									<td align="center" width="5%" ><?php
									if($_REQUEST["accion"]==1)
									{
		...
		<tr>
			<td >
				...
				<tr class="bloquecentralcuerpo">
					...
					$variable="pagina=admin_medicamento";	
...
function cadena_busqueda($configuracion,$usuario)
{
	...
	if(isset($_REQUEST["accion"]))
	{
		...
		switch($_REQUEST["accion"])
		{	
			//Todas las medicamentoes que el usuario haya creado
			case '1':				
				$cadena_sql.="WHERE ";
				$cadena_sql.="id_usuario=".$usuario." ";
				$cadena_sql.="ORDER BY atc ";				
				break;
