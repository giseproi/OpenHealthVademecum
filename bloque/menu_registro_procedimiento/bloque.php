			...
			<td >
				<table align="center" border="0" cellpadding="5" cellspacing="0" class="bloquelateral_2" width="100%">
					...
					<tr class="bloquelateralcuerpo">
						<td>
							<img width="100" height="31" src="<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/boton_reg_procedimiento_off.png" alt="Nuevo Procedimiento M&eacute;dico" title="Nuevo Procedimiento M&eacute;dico" border="0" usemap="#admin_reg_procedimiento" id="admin_reg_procedimiento" />
						</td>
					</tr>
				</table>
			</td>
				...
				<table align="center" border="0" cellpadding="5" cellspacing="0" class="bloquelateral_2" width="100%">
					...
					<tr>
						<td>
							...
							<tr>
								<td width=100% class="bloquelateralcuerpo">
									<INPUT type="radio" checked name="opcion" value="0"> Procedimiento.
								</td>
							</tr>
							<tr>
								<td width=100% class="bloquelateralcuerpo">
									<INPUT type="radio" name="opcion" value="1"> CUPS.
								</td>
							</tr>
							<tr>
								<td width=100% class="bloquelateralcuerpo">
...
<area shape="rect" coords="0,0,100,31" href="<?php		
							...
							?>" onmouseout="imagenOriginal()" onmouseover="cambiarImagen('admin_reg_procedimiento','<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/boton_reg_procedimiento_on.png')"/>
</map>