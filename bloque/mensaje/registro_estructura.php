	...
	<table cellpadding="7" cellspacing="0" class="bloquelateral">
		<tbody>
			...
			<tr class="bloquecentralcuerpo">
				...
				<ul>
					<li>Descargar el archivo de la plantilla:<br><a href="<?phpecho $configuracion["host"].$configuracion["site"].'/documento/lote_info_anual.xls'; ?>"><img width="16" height="16" src="<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/excel.gif"  border="0" /> Plantilla</a></li>
					<li>Ingresar los registros. Uno por cada fila.<br>Siguiendo la instrucciones espec&iacute;ficas del formato:<br>
					<a href="<?phpecho $configuracion["host"].$configuracion["site"].'/documento/lote_info_anual.pdf'; ?>"><img width="24" height="24" src="<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/pdf.jpg"  border="0" /> Instrucciones para ingresar registros en la plantilla.</a></li>
					</li>
