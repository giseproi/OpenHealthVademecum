			...
			<td >
				<table align="center" border="0" cellpadding="5" cellspacing="0" class="bloquelateral_2" width="100%">
					...
					<tr class="bloquelateralcuerpo">
						<td>
							<img width="110" height="31" src="<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/boton_consultorio_off.png" alt="Consultorio en l&iacute;nea" title="Consultorio en l&iacute;nea" border="0" usemap="#admin_consultorio" border="0" id="admin_consultorio" />
						</td>
					</tr>
					<tr class="bloquelateralcuerpo">
						<td>
					...
					<tr class="bloquelateralcuerpo">
						...
						<td>
							<img width="110" height="31" src="<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/boton_blog_off.png" alt="Blog Personal" title="Blog Personal" border="0" usemap="#admin_blog" border="0" id="admin_blog" />
						</td>
					</tr>
				</table>
			</td>
