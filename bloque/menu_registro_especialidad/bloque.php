			...
			<td >
				<table align="center" border="0" cellpadding="5" cellspacing="0" class="bloquelateral_2" width="100%">
					...
					<tr class="bloquelateralcuerpo">
						<td>
							<img width="100" height="31" src="<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/boton_reg_especialidad_off.png" alt="Nueva Especialidad M&eacute;dica" title="Nueva Especialidad M&eacute;dica" border="0" usemap="#admin_reg_especialidad" border="0" id="admin_reg_especialidad" />
						</td>
					</tr>
				</table>
			</td>
...
<map name="admin_reg_especialidad">
<area shape="rect" coords="0,0,100,31" href="<?php		
							$variable="pagina=registro_especialidad";
							$variable.="&opcion=nuevo";
							$variable=$cripto->codificar_url($variable,$configuracion);
							echo $indice.$variable;		
							?>" onmouseout="imagenOriginal()" onmouseover="cambiarImagen('admin_reg_especialidad','<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/boton_reg_especialidad_on.png')"/>
</map>