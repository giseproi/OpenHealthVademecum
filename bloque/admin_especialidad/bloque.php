	...
	{			?>	<tr class="bloquecentralcuerpo" >
		...
		if(($registro[$contador][7]!="") && ($registro[$contador][7]!="N/D"))
		{
					?>	
						...
						<img width="60" height="60" src="<?php echo $configuracion["host"].$configuracion["site"]."/fotografia/".$registro[$contador][7] ?>" alt="Imagen Caracter&iacute;stica" title="Imagen Caracter&iacute;stica" border="0" />
					<?php
		}	
					?>	</td>
						<td>
							<table width="100%" class="bloquecentralcuerpo" cellpadding="0" cellspacing="0">
								<tr>
									...
									echo $indice.$variable;	
						                        ?>"><b><?php echo $registro[$contador][2] ?></b></a>	
									</td>
									...
									$variable=$cripto->codificar_url($variable,$configuracion);
									echo $indice.$variable;	
									?>"><img width="24" heigth="24" src="<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]."/editar.png"?>" alt="Editar esta especialidad" title="Editar esta especialidad" border="0" />	
									</td>
								</tr>
								<tr>
									<td>
									...
									echo $indice.$variable;	
									?>"><img width="24" heigth="24" src="<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]."/boton_borrar.png"?>" alt="Borrar esta especialidad" title="Borrar esta especialidad" border="0" /></a>	
									</td>
								</tr>
								<tr>
									<td colspan="2">
		...
		<tr>
			<td >
				...
				<tr class="bloquecentralcuerpo">
					...
					$variable="pagina=admin_especialidad";	
